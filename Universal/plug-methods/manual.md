...
* **Reminder**: Do not delete right curly bracket at the very end of the SSDT-PLUG.aml file. Doing so will result in syntax error preventing you from compiling. Great example is the "Cleaned Up" image below which lacks said bracket.
